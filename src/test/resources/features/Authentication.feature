Feature: Información de usuario
  Scenario: Llave válida de cliente
    Given se desee consultar la información del cliente "pub_stagtest_g2u0HQd3ZMh05hsSgTS2lUV8t3s4mOt7"
  ...
  Scenario: Llave inválida de cliente
    Given se desee consultar la información del cliente "pub_stagtest_g2u0HQd3ZMh05hsSgTS2lUV8t3s41234"
    When envíe la solicitud
